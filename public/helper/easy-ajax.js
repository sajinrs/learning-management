(function($) {
    ...
    $.ajaxModal = function(selector, url, onLoad) {
        ...
        $(selector).modal();
        $(selector).on('shown.bs.modal', function () { console.log(url);
        ...
        $(selector).on('hidden.bs.modal', function () {
            ...
            $(this).find('.modal-footer').html('<button type="button" data-dismiss="modal"  class="btn btn-secondary default">Cancel</button>');
